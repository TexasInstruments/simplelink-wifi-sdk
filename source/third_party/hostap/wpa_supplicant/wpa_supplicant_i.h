...
#include "utils/ip_addr.h" //CC33XX
...
#define WILDCARD_SSID_SCAN ((struct wpa_ssid *) 1)
	...
	// TI - cc33xx compilation - cc33xx new flag 10.7.2016.
	// cc33xx initiated 'wpa select network' - used to allow scan with no profiles enabled (cc33xx wil supply the network only
	// after the network is found after the scan.
	int cc33xx_initiated_select_network;
...
// TI - cc33xx compilation - new for initializing globals
void wpa_mem_init();
