...
// TI - cc33xx compilation - allow cc33xx SW to produce extra IEs when needed
// This eliminates the need to keep extra IEs in ULL memory.
//original code - static struct wpabuf * wpa_supplicant_extra_ies(struct wpa_supplicant *wpa_s)
...
//	    wpa_s->scan_req == NORMAL_SCAN_REQ) {
	    if (!wpa_supplicant_enabled_networks(wpa_s) &&
	        wpa_s->scan_req == NORMAL_SCAN_REQ      &&
	        !wpa_s->cc33xx_initiated_select_network) {
...
{
// TI - cc33xx compilation - avoid redeclaration
#ifndef MIN
