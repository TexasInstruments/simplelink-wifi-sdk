			  ...
			  size_t ies_len)
{
	...
	wpa_printf(MSG_DEBUG,
		   ...
		   (uint32)assoc_data->ac_params[WMM_AC_BE].acm,
		   (uint32)assoc_data->ac_params[WMM_AC_BK].acm,
		   (uint32)assoc_data->ac_params[WMM_AC_VI].acm,
		   (uint32)assoc_data->ac_params[WMM_AC_VO].acm);
