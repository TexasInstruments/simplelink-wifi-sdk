		...
		*end = '\0';
		...
		if (methods[num_methods].vendor == EAP_VENDOR_IETF &&
			...
			wpa_printf(MSG_ERROR, "Line %d: unknown EAP method "
				   "'%s'", line, start);
			// TI - cc33xx compilation - edit the print below so it can use gtrace
...
//				   "See README for more information.");
			...
			wpa_printf(MSG_ERROR, "build time configuration.");
			wpa_printf(MSG_ERROR, "See README for more information.");
...
{
	//os_free(cert->ca_cert); //CC33xx - staticly allocated in cme AddAdHocEapProfile2DB //TODO:
	os_free(cert->ca_path);
	//os_free(cert->client_cert); //CC33xx - staticly allocated in cme AddAdHocEapProfile2DB //TODO:
	//os_free(cert->private_key); //CC33xx - staticly allocated in cme AddAdHocEapProfile2DB //TODO:
	//str_clear_free(cert->private_key_passwd); //CC33xx - staticly allocated in cme AddAdHocEapProfile2DB //TODO:
