...
#if  1 //defined(CC33xx)//cc33xx osi shared defines

//Defines and functions used only by supplicant
#define TEST_FAIL() 0
...
//Errors codes definitions used by the supplicant and not defined in our environment
#ifndef EAGAIN
#define EAGAIN      (11)
#endif
#ifndef ENOMEM
...
#ifndef os_realloc_array
//void * os_realloc_array(void *ptr, size_t nmemb, size_t size);
#define os_realloc_array(ptr, nmemb, size) (g_stub_func.os_realloc_array(ptr, nmemb, size))
#endif
...
#endif//cc33xx osi shared defines
#endif /* OS_H */
