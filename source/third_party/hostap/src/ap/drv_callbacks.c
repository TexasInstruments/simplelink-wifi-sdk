			  ...
			  union wpa_event_data *data)
{
	...
	case EVENT_TX_STATUS:
		switch (data->tx_state_status.tx_status.type) {
		case WLAN_FC_TYPE_MGMT:
			hostapd_mgmt_tx_cb(hapd, data->tx_state_status.tx_status.data,
					   data->tx_state_status.tx_status.data_len,
					   data->tx_state_status.tx_status.stype,
					   data->tx_state_status.tx_status.ack);
			break;
		case WLAN_FC_TYPE_DATA:
			hostapd_tx_status(hapd, data->tx_state_status.tx_status.dst,
					  data->tx_state_status.tx_status.data,
					  data->tx_state_status.tx_status.data_len,
					  data->tx_state_status.tx_status.ack);
			break;
		}
