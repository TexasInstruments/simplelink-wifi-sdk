...
//TI -Compilation - ap: explicitly disable some channels from country IE
static int hostapd_eid_country_skip_channel(const char *country,
...
#define BEACON_TAIL_BUF_SIZE 512
	...
	*pos++ = WLAN_EID_SSID;
	...
	params->current_rates = hapd->iface->current_rates;
	/////
...
//TI cc33xx compilation - TI compiler does not like this (due to the gtrace(?)).
//	if (res)
