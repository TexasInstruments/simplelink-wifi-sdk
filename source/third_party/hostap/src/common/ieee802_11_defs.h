...
//Ti Compilation - mu edca ie
#define WLAN_EID_EXT_MU_EDCA 38 // To Do check if needed
...
#define WLAN_EXT_CAPAB_BYTE(ext_capab_bit) (ext_capab_bit / 8)
...
#define WLAN_EXT_CAPAB_BYTE_1 1
...
/* 63 - Max Number of MSDUs In A-MSDU[0] */

/* 64 - Max Number of MSDUs In A-MSDU[1] */
...
//Ti compiler - cc3xxx - Arm compiler not supporting uint long long gcc packed, switched to pragama
//TODO: Gil, print sizeof(rrm_measurement_beacon_report) make sure it's 18 and sizeof(multi_band_ie) to make sure it's aligned to 1
#pragma pack(push,1)
