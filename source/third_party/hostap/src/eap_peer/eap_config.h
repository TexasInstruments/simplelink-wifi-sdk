...
#define EAP_CONFIG_FLAGS_EXT_MACHINE_PASSWORD BIT(3)
	...
	/*CC33XX code change CC33XX code change*/
	//since ent profile is stored in FS, we must determine the index of that entry
	//and it must be part of the wpa_ssid entry
	uint8 sl_entProfileIndex;
	/*CC33XX code change CC33XX code change*/
