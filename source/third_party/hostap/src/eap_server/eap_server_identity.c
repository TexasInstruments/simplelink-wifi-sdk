...
// TI - cc33xx compilation - avoid compilation error
struct eap_identity_data {
	enum { CONTINUExxx, SUCCESSxxx, FAILURExxx } state;
	int pick_up;
};
